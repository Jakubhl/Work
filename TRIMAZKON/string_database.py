...
#                             "nastavení default rozhraní pro editaci IP adresy",
#                             "spousteci okno: na oblibenych"
#                             "spousteci okno: zobrazeni disku = 1, normal",
#                             "zakladni velikost okna normal = 0, max = 1,min",
#                             "aktualizovat statusy disků při vstupu do okna s disky (default)",
#                             "editovatelné(1)/ needitovatelné(0) poznámky (default)",
#                             "disk persistentní - yes(1)/ no(0)",
#                             "automaticky přesouvat upravené projekty na začátek",
...
default_setting_database_param = [["bmp","png"],
                                ...
                                "ano",
                                55,
                                ["Temp","Pairs","Ke_smazani","Konvertovane_BMP","Konvertovane_JPG","Kopírované_obrázky","Přesunuté_obrázky"],
                                "ano",
                                [2,30,40,"ano",6],
                                "ne",
                                ["Sharepoint_databaze.xlsx","Katalog_kamerového_vybavení","_metadata_catalogue",0,"xlsx","C:/Users/","fast"],
                                80,
                                "ano",
                                "ne",
                                "cz",
