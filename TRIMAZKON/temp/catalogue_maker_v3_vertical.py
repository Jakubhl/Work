...
class Catalogue_gui:
    ...
    def make_block(self,master_widget,height,width,fg_color,text,side,dummy_block = False,tier = "",border_color="#636363"):
        if dummy_block:
            ...
            block_widget.       pack(pady = (0,0),padx =0,expand = False,side = side,anchor="w",fill="x")
            ...
            block_name.         pack(pady = 5,padx =5,expand = True,anchor="w")
            ...
            self.temp_frame_widget = block_widget
            return block_name
