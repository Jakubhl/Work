...
class main:
    ...
    class Disk_management_gui:
        ...
        def create_widgets_disk(self,init=None):
            ...
            button_settings =               customtkinter.CTkLabel(master = first_row_frame,text = "",width=36,image =customtkinter.CTkImage(Image.open(Tools.resource_path("images/settings.png")),size=(32, 32)),bg_color="#212121")
            button_settings.                bind("<Enter>",lambda e: button_settings._image.configure(size=(36,36)))
            button_settings.                bind("<Leave>",lambda e: button_settings._image.configure(size=(32,32)))
            button_settings.                bind("<Button-1>",lambda e: self.setting_window())
    ...
    class IP_assignment: # Umožňuje měnit statickou IP
        ...
        def create_widgets(self,fav_status = None,init=None,excel_load_error = False):
            ...
            button_settings =               customtkinter.CTkLabel(master = first_row_frame,width=36,text = "",image =customtkinter.CTkImage(Image.open(Tools.resource_path("images/settings.png")),size=(32, 32)),bg_color="#212121")
            button_settings.bind("<Enter>",lambda e: button_settings._image.configure(size=(36,36)))
            button_settings.bind("<Leave>",lambda e: button_settings._image.configure(size=(32,32)))
            button_settings.bind("<Button-1>",lambda e: self.setting_window())
