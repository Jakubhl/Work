...
def Deleting_option(list_of_menu_frames):
    ...
    def call_menu():
        list_of_frames = [frame_with_logo,frame2,frame3]
    ...
    frame3.pack(pady=10,padx=5,fill="both",expand=True,side = "bottom")
    ...
    checkbox = customtkinter.CTkCheckBox(master = frame3, text = "Mazání souborů starších než: ...",command = selected)
    checkbox.pack(pady =12,padx=10,anchor ="w")
    checkbox2 = customtkinter.CTkCheckBox(master = frame3, text = "Redukce novějších, mazání souborů starších než: ...",command = selected2)
    checkbox2.pack(pady =12,padx=10,anchor ="w")
    checkbox3 = customtkinter.CTkCheckBox(master = frame3, text = "Mazání adresářů s názvem ve formátu YY_MM_DD",command = selected3)
    checkbox3.pack(pady =12,padx=10,anchor ="w")
    checkbox4 = customtkinter.CTkCheckBox(master = frame3, text = "rezerva",command = selected4)
    checkbox4.pack(pady =12,padx=10,anchor ="w")
    checkbox5 = customtkinter.CTkCheckBox(master = frame3, text = "rezerva",command = selected5)
    checkbox5.pack(pady =12,padx=10,anchor ="w")

    console = customtkinter.CTkLabel(master = frame3,text = " ",justify = "left",font=("Arial",15))
