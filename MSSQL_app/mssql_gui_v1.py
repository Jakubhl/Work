...
if testing:
    exe_name = "jhv_sql_test.exe"

import customtkinter
import time
from PIL import Image
# import sharepoint_download as download_database
import mssql_tray_v1 as mssql_tray
import mssql_changelog
...
class Tools:
        task_name = "jhv_sql_startup_tray_setup"
        ...
        def read_json_config(cls): # Funkce vraci data z configu
            ...
            default_setting_parameters = mssql_changelog.default_setting_database_param
            # default_labels = mssql_changelog.default_setting_database
        ...
        def tray_startup_cmd(cls):
            ...
            def call_tray_class():
                tray_app_instance = mssql_tray.tray_app_service(initial_path,app_icon,exe_name,config_filename)
            ...
            try:
                while True:
                    ...
                    if "Establish main menu gui" in received_data:
                        ...
                        trimazkon_tray_instance = mssql_tray.tray_app_service(initial_path,app_icon,exe_name,config_filename)
...
class main_menu:
    ...
    def call_mssql_manager(self):
        self.clear_frames()
        self.root.unbind("<f>")
        mssql_manager(self.root)
    ...
    def fill_changelog(self,change_log):
        ...
        for string_element in mssql_changelog.change_log_list:
    ...
    def menu(self,initial=False,catalogue_downloaded = False,zoom_disable = False,clear_root = False): # Funkce spouští základní menu při spuštění aplikace (MAIN)
        ...
        ip_setting_button =     customtkinter.CTkButton(master= frame_with_buttons, width= 400,height=100, text = "test", command = lambda: self.call_mssql_manager(),font=("Arial",25,"bold"))
...
class Advanced_option: # Umožňuje nastavit základní parametry, které ukládá do textového souboru
    ...
    def __init__(self,root,windowed=None,spec_location=None,path_to_remember = None,last_params = None,tray_setting_status_message = None):
        ...
        default_dir_names = mssql_changelog.default_setting_database_param
...
class mssql_manager: # Umožňuje nastavit možnosti třídění souborů
    """
